...
class ContactInfoPage extends ConsumerStatefulWidget {
  final int friendRequestReceiverResponse;
...
class _ContactInfoPageState extends ConsumerState<ContactInfoPage> {
  ...
  Widget build(BuildContext context) {
    final patientIdResponse =
        ref.watch(userPatientIdProvider(widget.friendRequestReceiverResponse));
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: patientIdResponse.when(
          ...
          error: (error, _) =>
              const Center(child: Text('Doctor module coming soon')),
          data: (patientProfile) {
            return SingleChildScrollView(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  patientProfile.pictureUrl != null &&
                          patientProfile.pictureUrl!.isNotEmpty
                      ? ClipOval(
                          child: Image.network(
                            patientProfile.pictureUrl!.contains('uploads')
                                ? '${AppConstants.imageURL}${patientProfile.pictureUrl!}'
                            ...
                            errorBuilder: (context, error, stackTrace) {
                              return CircleAvatar(
                                ...
                                backgroundColor: getAvatarColor(
                                    patientProfile.firstName.toString() +
                                        patientProfile.lastName.toString()),
                                child: Text(
